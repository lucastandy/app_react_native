...
import { Container, Logo, ImageLogo, List, RowData, Bmi, Classification, InputForm, BtnSubmitForm, TxtSubmitForm, RowDataSelect } from './app/src/styles/custom';
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <Container>
        ...
        <List>
          {bmiValue < 18 && bmiValue !== '' ? (
            <>
              <RowDataSelect>
                <Bmi>Menor que 18,5</Bmi>
                <Classification>Magreza</Classification>
              </RowDataSelect>
            </>
          ) : (
            <>
          ...
          {bmiValue >= 18.01 && bmiValue <= 24.90 && bmiValue !== '' ? (
            <>
              <RowDataSelect>
                <Bmi>Entre 18,5 e 24,9</Bmi>
          ...
          {bmiValue >= 25 && bmiValue <= 29.90 && bmiValue !== '' ? (
            <>
              <RowDataSelect>
                <Bmi>Entre 25,0 e 29,9</Bmi>
                <Classification>Sobrepeso</Classification>
              </RowDataSelect>
            </>
          ) : (
            <>
          ...
          {bmiValue >= 30 && bmiValue <= 39.90 && bmiValue !== '' ? (
            <>
              <RowDataSelect>
                <Bmi>Entre 30,0 e 39,9</Bmi>
                <Classification>Obesidade</Classification>
              </RowDataSelect>
            </>
          ) : (
            <>
          ...
          {bmiValue >= 40 && bmiValue !== '' ? (
            <>
              <RowDataSelect>
                <Bmi>Maior que 40,00</Bmi>
                <Classification>Obesidade Grave</Classification>
              </RowDataSelect>
            </>
          ) : (
            <>
